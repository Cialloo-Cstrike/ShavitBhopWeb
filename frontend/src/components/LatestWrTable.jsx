...
const LatestWrTable = ({ data }) => (
  <div className="LatestWrTableContainer">
    <table className="LatestWrTable">
      <thead>
        <tr>
          <th>Map</th>
          <th>Name</th>
